...
public class Joueur {
    ...
    public void setSymb(String symbol) { // on crée une méthode setSymb qui va nous permettre de définir la valeur de la
                                         // variable symbols
        this.symbol = symbol;
    }
    ...
    public Joueur(String nom, String symbols, String couleur) { // on crée une méthode constructeur qui va nous
                                                                // permettre de créer un joueur
